...
public class ExampleEntityModel<T extends ExampleEntity> extends EntityModel<T> {
    ...
    private final ExampleEntityParts parts;

    public ExampleEntityModel(ModelPart root) {
        ModelPart body = root.getChild("body");
        ModelPart legs = body.getChild("legs");
        this.parts = new ExampleEntityParts(body, body.getChild("head"), legs, legs.getChild("frontLeft"),
                legs.getChild("frontRight"), legs.getChild("backLeft"), legs.getChild("backRight"));
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-5.0F, -4.0F, -7.5F, 10.0F, 8.0F, 15.0F, new CubeDeformation(0.0F)),
        ...
        legs.addOrReplaceChild("frontLeft", CubeListBuilder.create().texOffs(34, 24)
                        .addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(4.0F, -5.0F, -6.0F));

        legs.addOrReplaceChild("frontRight", CubeListBuilder.create().texOffs(25, 32)
                        .addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(-4.0F, -5.0F, -6.0F));

        legs.addOrReplaceChild("backRight", CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(-4.0F, -5.0F, 7.0F));

        legs.addOrReplaceChild("backLeft", CubeListBuilder.create().texOffs(25, 24)
                        .addBox(-1.0F, 0.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(4.0F, -5.0F, 7.0F));

        body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 24)
                        .addBox(-3.0F, -6.0F, -4.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.parts.legs().xRot = ((float) Math.PI / 2F);
    ...
    public ExampleEntityParts getParts() {
        return this.parts;
    }

    public record ExampleEntityParts(ModelPart body, ModelPart head, ModelPart legs, ModelPart frontLeftLeg,
                                     ModelPart frontRightLeg, ModelPart backLeftLeg, ModelPart backRightLeg) {
    }
}